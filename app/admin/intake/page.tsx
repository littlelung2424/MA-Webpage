...
function displayFileSize(size: number | null) {
...
function AdminErrorCard({ message }: { message: string }) {
  return (
    <div className="admin-error-card" role="status">
      ...
      <p>
        Table configured for this deployment:{" "}
        <code>{SUPABASE_INTAKE_TABLE}</code>.
      </p>
    </div>
  );
}
        ...
        <div className="admin-submission-list">
          {!error && submissionsWithFiles.length === 0 && (
            <p className="admin-empty-card">
              No active intake submissions yet.
            </p>
          )}
                ...
                <article className="admin-submission-card" key={submission.id}>
                  <header className="admin-submission-header">
                    ...
                    <div className="admin-meta">
                      <span
                        className={`admin-status-pill status-${normalizeStatus(submission.status).toLowerCase()}`}
                      >
                  ...
                  <div className="admin-content-grid">
                    <section>
                      ...
                      <p>
                        {submission.task || "No task description provided."}
                      </p>
                    </section>
                    <section>
                      <h3>Desired outcome</h3>
                      <p>
                        {submission.success || "No desired outcome provided."}
                      </p>
                    </section>
                    <section>
                      <h3>Anything else</h3>
                  ...
                  <form className="admin-update-form" action={updateSubmission}>
                    ...
                    <label>
                      ...
                      <select
                        name="status"
                        defaultValue={normalizeStatus(submission.status)}
                      >
